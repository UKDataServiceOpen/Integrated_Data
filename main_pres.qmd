...
- Results: quality depends on condition:
  ...
  - Potentially cheaper
  - But not devoid of techncial difficulties
...
- [DIGISURVOR](https://digisurvor.github.io/main/) project for an exemple of current research
...
- Examples:
   - Data from fitness trackers, smartwatches, loyalty cards, purchase records and in-car smart tech: health and mobility behaviiour    
   - Financial transactions by  businesses and individuals < banks, supermarkets: financial behaviour and resilience
   - Energy network data (distribution & consumption); EV usage and charging; smart meter readings: building/households energy consumptions; net zero targets


## Bio measurement data

- Measured as part large scale longitudinal surveys (often via nurse visit):
...
- Four so far: people born in 1958(NCDS), 1970(BCS), 2000 (MCS), 2026 (Generation New Era)
...
- Large sample, drawn from NI records: 135,000-190,000 individuals per year
...
- Data protection & GDPR - rpe;requisite <- UKDS Safe researcher
- Departmental regulations in case of Governmental data
- Institutional/procedural: ie how to engage with the matching interface 
